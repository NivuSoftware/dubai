            ...
            <div className="space-y-8">
              <div className="relative px-2 py-6 sm:px-6 sm:py-10">
                ...
                <div className="relative mx-auto max-w-5xl text-center">
                  <blockquote className="font-[Georgia] text-4xl italic leading-tight text-[#ffffff] sm:text-5xl lg:text-6xl">
                    "Una mujer debe ser dos cosas: quien ella quiera y lo que ella quiera."
                  </blockquote>
                  <p className="mt-5 text-sm uppercase tracking-[0.32em] text-[#D4AF37]">
                    COCO CHANEL
                  </p>
                  <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-[#EDE0C8] sm:text-base">
                    Recomienda a una nueva anunciante y recibe 24 horas extra de visibilidad.
                  </p>
                </div>
              </div>

              <div className="flex justify-center">
                <p className="inline-flex items-center gap-2 rounded-full border border-[#C9A227]/50 bg-[#C9A227]/12 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.28em] text-[#C9A227]">
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex shrink-0 flex-col items-end gap-2">
                        <span className="rounded-full border border-[#C9A227]/45 bg-[#C9A227]/10 px-3 py-1 text-sm font-semibold text-[#C9A227]">
                          {plan.price} <span className="text-[11px] font-medium text-[#EDE0C8]">(incluye IVA)</span>
                        </span>
                ...
                {anuncios.map((anuncio) => (
                  ...
                  >
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                      ...
                      <p className="text-gray-400">
                        Precio: <span className="text-[#C9A227]">${Number(anuncio.precio).toFixed(2)}</span>
                      </p>
                    </div>
        ...
        <div className="fixed inset-0 z-[85] flex items-start justify-center bg-black/70 px-2 py-2 backdrop-blur-sm sm:items-center sm:px-4 sm:py-6">
          <div className="max-h-[94vh] w-full max-w-xl overflow-y-auto rounded-xl border border-[#1f7fd8]/40 bg-[#0d1320] p-3 sm:rounded-2xl sm:p-6">
            ...
            <form onSubmit={handlePaymentStepSubmit} className="space-y-3">
              ...
              <div className="rounded-xl border border-[#C9A227]/35 bg-[#C9A227]/10 p-4 text-sm text-[#EDE0C8]">
                <p>
                  Valor a pagar:{" "}
      ...
      {showAnuncioModal ? (
        <div className="fixed inset-0 z-[86] flex items-start justify-center bg-black/70 px-2 py-2 backdrop-blur-sm sm:items-center sm:px-4 sm:py-8">
          <div className="max-h-[94vh] w-full max-w-md overflow-y-auto rounded-xl border border-white/20 bg-[#0d1320] p-3 sm:max-w-3xl sm:rounded-2xl sm:p-6 lg:p-8">
            ...
            <div className="mb-3 rounded-lg border border-[#C9A227]/25 bg-[#C9A227]/10 px-3 py-2 text-sm text-[#EDE0C8]">
